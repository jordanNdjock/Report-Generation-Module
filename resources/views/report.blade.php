...
<body>
    <form method="post" action="{{ route('view.report')}}">
        ...
        @if(count($selectedTitles) > 0)
            @foreach($selectedTitles as $title)
                <div class="section">
                    ...
                    <input type="hidden" name="selectedTitles[]" value="{{ $title }}">
            ...
            <div class="d-flex justify-content-center align-items-center mt-5">
                <button type="submit" class="text-light fs-5 fw-bold btn rounded-3 btn-xs" style="background : rgb(246, 175, 2);font-family: 'Open Sans';">
                visualiser <i class="bi bi-eye-fill"></i></button>
            </div>
        @else
